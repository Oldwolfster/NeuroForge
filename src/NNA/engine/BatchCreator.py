...
class TrainingBatch:
    """
    Manages batch training runs with support for:
    - Creating new batches with dimension sweeps
    - Rerunning specific configs for visualization
    ...
    def prep_dimensions(self):
        dimensions = self.hyper.dimensions.copy()
